...
namespace Given_that_an_entity_class_without_Table_attribute_is_available
{
	...
	public sealed class When_attempted_to_generate_INSERT_query
	{
		...
		[TestMethod]
		public void Should_generate_empty_INSERT_query_text_for_incompatible_entity ()
		{
			var insertQuery = this.incompatibleTestEntity.GetInsertQuery ();
			insertQuery.Should ().BeEmpty ();
		}
	}
}